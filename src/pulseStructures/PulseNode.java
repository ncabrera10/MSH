...
/**
 * This class represents a node in the pulse graph. Here you will find the function pulse and pulsewithqueues.
 * @author nick0
 *
 */
						...
						//Check the incoming arcs (Remember we are going backwards!)
							...
							for(Iterator<PulseArc> iter = incomingArcs.iterator();iter.hasNext();) {
								...
								//Relevant info for the arc and the tail
									...
									newWeights[2] = (pulseWeights[2] + a.getDist()); //Time after adding the node
